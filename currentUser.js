...
depositAmount.value = '';
depositDescription.value = '';
showNotification(`Deposit of $${amount.toLocaleString()} processed successfully!`, 'success');
// Process transfer
...
transferAmount.value = '';
transferMemo.value = '';
showNotification(`Transfer of $${amount.toLocaleString()} completed successfully!`, 'success');
// Show notification
